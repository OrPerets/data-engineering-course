# Build Week 11: Feature Engineering for Data Systems
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/11-feature-engineering/practice.md`
...
1. `lectures/11-feature-engineering/lecture.md`
2. `lectures/11-feature-engineering/practice.md`
...
* Search `sources/` for anything relevant to `Feature Engineering for Data Systems`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week11_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week11_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Feature Engineering for Data Systems` and enforce them.
...
## Diagram Manifest
- Slide XX → week11_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week11_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week11_practice_slideXX_... → purpose
