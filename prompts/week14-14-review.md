# Build Week 14: Course Review and Exam Preparation
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/14-review/practice.md`
...
1. `lectures/14-review/lecture.md`
2. `lectures/14-review/practice.md`
...
* Search `sources/` for anything relevant to `Course Review and Exam Preparation`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week14_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week14_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Course Review and Exam Preparation` and enforce them.
...
## Diagram Manifest
- Slide XX → week14_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week14_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week14_practice_slideXX_... → purpose
