# Build Week 4: Data Ingestion and ETL Pipelines
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/04-etl-ingestion/practice.md`
...
1. `lectures/04-etl-ingestion/lecture.md`
2. `lectures/04-etl-ingestion/practice.md`
...
* Search `sources/` for anything relevant to `Data Ingestion and ETL Pipelines`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week4_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week4_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Data Ingestion and ETL Pipelines` and enforce them.
...
## Diagram Manifest
- Slide XX → week4_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week4_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week4_practice_slideXX_... → purpose
