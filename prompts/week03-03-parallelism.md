# Build Week 3: Parallelism and Divide-and-Conquer
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/03-parallelism/practice.md`
...
1. `lectures/03-parallelism/lecture.md`
2. `lectures/03-parallelism/practice.md`
...
* Search `sources/` for anything relevant to `Parallelism and Divide-and-Conquer`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week3_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week3_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Parallelism and Divide-and-Conquer` and enforce them.
...
## Diagram Manifest
- Slide XX → week3_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week3_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week3_practice_slideXX_... → purpose
