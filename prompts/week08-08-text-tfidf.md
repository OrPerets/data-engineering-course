# Build Week 8: Text Processing at Scale: TF-IDF
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/08-text-tfidf/practice.md`
...
1. `lectures/08-text-tfidf/lecture.md`
2. `lectures/08-text-tfidf/practice.md`
...
* Search `sources/` for anything relevant to `Text Processing at Scale: TF-IDF`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week8_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week8_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Text Processing at Scale: TF-IDF` and enforce them.
...
## Diagram Manifest
- Slide XX → week8_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week8_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week8_practice_slideXX_... → purpose
