# Build Week 9: Advanced Text Processing Techniques
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/09-text-advanced/practice.md`
...
1. `lectures/09-text-advanced/lecture.md`
2. `lectures/09-text-advanced/practice.md`
...
* Search `sources/` for anything relevant to `Advanced Text Processing Techniques`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week9_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week9_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Advanced Text Processing Techniques` and enforce them.
...
## Diagram Manifest
- Slide XX → week9_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week9_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week9_practice_slideXX_... → purpose
