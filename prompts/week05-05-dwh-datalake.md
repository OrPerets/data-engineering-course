# Build Week 5: Data Warehousing and Data Lakes
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/05-dwh-datalake/practice.md`
...
1. `lectures/05-dwh-datalake/lecture.md`
2. `lectures/05-dwh-datalake/practice.md`
...
* Search `sources/` for anything relevant to `Data Warehousing and Data Lakes`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week5_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week5_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Data Warehousing and Data Lakes` and enforce them.
...
## Diagram Manifest
- Slide XX → week5_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week5_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week5_practice_slideXX_... → purpose
