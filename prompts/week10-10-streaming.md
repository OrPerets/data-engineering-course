# Build Week 10: Streaming Data and Real-Time Processing
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/10-streaming/practice.md`
...
1. `lectures/10-streaming/lecture.md`
2. `lectures/10-streaming/practice.md`
...
* Search `sources/` for anything relevant to `Streaming Data and Real-Time Processing`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week10_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week10_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Streaming Data and Real-Time Processing` and enforce them.
...
## Diagram Manifest
- Slide XX → week10_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week10_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week10_practice_slideXX_... → purpose
