# Build Week 7: Advanced MapReduce and Data Skew
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/07-mapreduce-advanced/practice.md`
...
1. `lectures/07-mapreduce-advanced/lecture.md`
2. `lectures/07-mapreduce-advanced/practice.md`
...
* Search `sources/` for anything relevant to `Advanced MapReduce and Data Skew`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week7_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week7_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Advanced MapReduce and Data Skew` and enforce them.
...
## Diagram Manifest
- Slide XX → week7_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week7_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week7_practice_slideXX_... → purpose
