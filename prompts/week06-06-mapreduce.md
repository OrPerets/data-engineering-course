# Build Week 6: MapReduce Fundamentals
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/06-mapreduce/practice.md`
...
1. `lectures/06-mapreduce/lecture.md`
2. `lectures/06-mapreduce/practice.md`
...
* Search `sources/` for anything relevant to `MapReduce Fundamentals`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week6_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week6_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `MapReduce Fundamentals` and enforce them.
...
## Diagram Manifest
- Slide XX → week6_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week6_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week6_practice_slideXX_... → purpose
