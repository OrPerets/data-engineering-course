# Build Week 12: Advanced Feature Engineering Pipelines
...
* Canonical course content must be written in **Markdown only** under:
  ...
  * `lectures/12-feature-engineering-advanced/practice.md`
...
1. `lectures/12-feature-engineering-advanced/lecture.md`
2. `lectures/12-feature-engineering-advanced/practice.md`
...
* Search `sources/` for anything relevant to `Advanced Feature Engineering Pipelines`.
* Also scan root:
  * `exercises1.md`
  * `exercises2.md`
...
```text
week12_{lecture|practice}_slide{SLIDE_NO}_{short_description}.puml
````
...
* `Diagram: week12_lecture_slide{SLIDE_NO}_...`
...
Select the appropriate mode(s) based on `Advanced Feature Engineering Pipelines` and enforce them.
...
## Diagram Manifest
- Slide XX → week12_lecture_slideXX_... → purpose
...
- Step 1
- Diagram: week12_lecture_slideXX_...
...
## Diagram Manifest
- Slide XX → week12_practice_slideXX_... → purpose
